...
import { CircleSlash, Flame, Info, Plus, Filter, X, Link, Pizza } from "lucide-react";
...
export default function MenuPage() {
  ...
  const FilterPanelContent = () => (
    <>
      <div>
        <h3 className="font-poppins-bold text-lg mb-3 text-stone-700">Poziom ostrości</h3>
      ...
      <div>
        <h3 className="font-poppins-bold text-lg mb-4 text-stone-700">Składniki</h3>
      ...
      <div className="w-full bg-[url(/pizza-pattern.png)] flex justify-center">
        <div className="bg-white w-full max-w-7xl shadow-2xl">
                            ...
                            <Popover>
                              ...
                              <PopoverContent className="w-64 text-sm p-5">
                                ...
                                <div className="mb-3">
                                  ...
                                  <ul className="list-disc list-inside pl-1 space-y-0.5 text-xs text-stone-700">
          ...
          <section className="bg-stone-50 text-center py-12 md:py-16 px-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-poppins-bold text-stone-800 mb-3">
