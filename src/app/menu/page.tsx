              ...
              <main className="w-full lg:w-[70%] xl:w-3/4">
                ...
                {filteredMenuItems.length > 0 ? (
                              ...
                              <PopoverContent className="w-64 text-sm p-5">
                                ...
                                <div className="mb-3">
                                 ...
                                 <ul className="text-xs space-y-1">
                                   <li>Mała: <span className="font-semibold">{item.price.small.toFixed(2).replace('.',',')} zł</span></li>
                                   <li>Średnia: <span className="font-semibold">{item.price.medium.toFixed(2).replace('.',',')} zł</span></li>
                                   <li>Duża: <span className="font-semibold">{item.price.large.toFixed(2).replace('.',',')} zł</span></li>
                                 </ul>
                              </PopoverContent>
                            </Popover>
                          </div>
                  ...
                  <div className="text-center py-16 col-span-full">
                    ...
                    <p className="text-base mt-2">Spróbuj zmienić wybrane filtry lub <Button variant="link" onClick={resetFilters} className="text-red-600 p-0 h-auto">wyczyść wszystkie</Button>.</p>
                  </div>
                )}
              </main>
            </div>
