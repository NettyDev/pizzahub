        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-stretch">
            ...
            <div className="w-full lg:w-3/5 rounded-xl overflow-hidden shadow-xl border border-stone-200">
              ...
              ></iframe> */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5041.239900617025!2d19.114507112715298!3d50.81967977154692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4710b5d481ddea05%3A0xd326c01b910dcbf7!2sAleja%20Armii%20Krajowej%2013%2F15%2C%2042-202%20Cz%C4%99stochowa!5e0!3m2!1spl!2spl!4v1748951772352!5m2!1spl!2spl"
                className="w-full h-96 md:h-[520px]"
                allowFullScreen
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
            ...
            <div className="w-full lg:w-2/5 flex flex-col gap-8">
              ...
              <div className="bg-stone-50 rounded-xl shadow-lg p-6 border border-stone-200">
                ...
                <div className="font-poppins text-stone-700 text-base pl-9">
                  <p>
                    Poniedziałek - Piątek: <strong>12:00 - 22:00</strong>
                  </p>
                  <p className="mt-1">
                    Sobota - Niedziela: <strong>12:00 - 02:00</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="bg-stone-50 rounded-xl shadow-lg p-6 border border-stone-200">
                ...
                <div className="font-poppins text-stone-700 text-base pl-9">
                  ...
                  <p className="mt-1">
                    Email:{" "}
                    <a
                      href="mailto:kontakt@pizzahub.pl"
                      className="text-red-600 hover:text-red-700 font-semibold break-all"
                    >
                      kontakt@pizzahub.pl
                    </a>
                  </p>
