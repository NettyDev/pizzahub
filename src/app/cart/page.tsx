        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 xl:gap-16">
          <div className="w-full lg:w-[60%] xl:w-2/3 flex flex-col gap-8">
            <section className="bg-white rounded-lg shadow-lg p-6 sm:p-8 border border-stone-200">
              <h2 className="text-xl sm:text-2xl mb-6 text-stone-700 text-shadow-xs">Płatność</h2>
              <PaymentMethod />
            </section>
            ...
            <section className="bg-white rounded-lg shadow-lg p-6 sm:p-8 border border-stone-200">
              ...
              <div className="mt-8 pt-6 border-t border-stone-200">
                <h3 className="text-lg mb-4 text-stone-700 text-shadow-xs">Dokument sprzedaży</h3>
                <RadioGroup
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      value="paragon"
                      id="paragon"
                      className="h-4 w-4 border-stone-400 rounded-sm text-red-600 focus:ring-offset-0 focus:ring-2 focus:ring-red-500 data-[state=checked]:bg-red-600 data-[state=checked]:border-red-600 [&_svg]:fill-white"
                    />
                    <Label htmlFor="paragon" className="text-sm text-stone-700 cursor-pointer">
                      Paragon
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      ...
                      className="h-4 w-4 border-stone-400 rounded-sm text-red-600 focus:ring-offset-0 focus:ring-2 focus:ring-red-500 data-[state=checked]:bg-red-600 data-[state=checked]:border-red-600 [&_svg]:fill-white"
                    />
                    <Label htmlFor="faktura" className="text-sm text-stone-700 cursor-pointer">
                      Faktura VAT
                    </Label>
                  </div>
                </RadioGroup>
              ...
              {showInvoiceFields && (
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                  ...
                  <FormInput
                    label="Kod pocztowy i miasto firmy"
                    id="invoiceCity"
                    placeholder="np. 00-001 Radomsko"
                    required
                  />
                </div>
              )}
              <div className="mt-8 pt-6 border-t border-stone-200">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="comment" className="border-b-0">
                    <AccordionTrigger className="text-stone-700 hover:no-underline text-base py-3 group">
