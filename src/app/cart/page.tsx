...
import { CircleCheck, CircleDollarSign, Truck, Calendar1 } from "lucide-react";
        ...
        <div className="items-center justify-center gap-8 py-5 px-6 w-full">
          <div className="flex flex-col items-center justify-center w-full shadow-lg  p-6">
            <div className="items-left justify-start w-full px-4">
              ...
              <RadioGroup defaultValue={pay_options[0].value} className="w-full grid grid-row gap-4">
              ...
              <div className="w-full p-6 rounded-md">
                ...
                <div className="flex flex-row items-start justify-between w-full gap-4 p-2">
                  <div className="flex flex-col w-1/2">
                    ...
                    <input type="text" placeholder="Ulica" className="border border-gray-300 rounded-md p-2" />
                  </div>
                  <div className="flex flex-col w-1/2">
                    <p className="font-poppins-bold">Numer domu *</p>
                    <input type="text" placeholder="Numer domu" className="border border-gray-300 rounded-md p-2" />
                  </div>
                </div>
                <p className="font-poppins-bold">Miasto *</p>
                <input type="text" placeholder="Miasto" className="border border-gray-300 rounded-md p-2 w-full mt-2" />
                ...
                <input type="text" placeholder="Piętro" className="border border-gray-300 rounded-md p-2 w-full mt-2" />
                <p className="font-poppins-bold">Firma</p>
                <input type="text" placeholder="Firma" className="border border-gray-300 rounded-md p-2 w-full mt-2" />
              </div>
            )}
            ...
            <div className="items-left justify-start w-full mt-2">
              ...
              <div className="flex flex-row items-start justify-between gap-4 p-2 w-full">
                ...
                <div className="w-1/2 p-3">
                  ...
                  <input type="text" placeholder="Telefon" className="border border-gray-300 rounded-md p-2 w-full" />
                </div>
                {/* 2 */}
                <div className="w-1/2 p-3">
                  <p className="font-poppins-bold">Nazwisko *</p>
                  <input type="text" placeholder="Nazwisko" className="border border-gray-300 rounded-md p-2 w-full" />
          ...
          <div className="flex flex-col items-center justify-center w-full shadow-md shadow-red-700/10 rounded-xs p-6">
            ...
            <div className="w-full border-t border-red-500 mt-3 py-2">
              <div className="flex flex-row items-center justify-between p-2">
                <span className="text-lg font-bold font-poppins-bold flex items-center gap-2">Pizza Hawajska</span>
                <span className="text-lg font-bold">20 zł</span>
              </div>
            </div>
            <div className="w-full border-t border-red-500 mt-3">
              <div className="flex flex-row items-center justify-between p-2">
                <span className="text-md font-poppins-bold text-gray-700 flex items-center gap-2">Suma częściowa</span>
