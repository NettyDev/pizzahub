...
const pay_options = [
  { value: "payu", label: "PayU", description: "Szybka płatność online" },
  { value: "card", label: "Karta kredytowa", description: "Płatność kartą kredytową" },
  { value: "cash", label: "Gotówka", description: "Płatność przy odbiorze" }
];

export default function PaymentMethod() {
    return (
        <RadioGroup defaultValue={pay_options[0].value} className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
