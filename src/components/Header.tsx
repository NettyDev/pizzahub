      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8" style={{ height: `${navSectionHeight}px` }}>
          <div className="flex items-center justify-center h-full relative">
            ...
            <div className="absolute right-0 flex items-center gap-x-2 sm:gap-x-3">
              <Link href="/cart" passHref>
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full hover:cursor-pointer hover:bg-red-50 text-stone-700 hover:text-red-700 transition-colors"
                >
                  ...
                  {isPending ? (
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link href="/profile" passHref>
                        <Button
                          variant="ghost"
                          className="w-full justify-start px-3 py-2 text-sm text-stone-700 hover:bg-stone-100 rounded-none"
                        >
