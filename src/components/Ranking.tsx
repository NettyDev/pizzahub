...
const topPizzasData: Pizza[] = [
  ...
  },
  {
    ...
    name: "Wege Raj",
    imageUrl: "/pizzas/example.png",
    description: "Bogactwo świeżych warzyw dla wegetarian.",
    rank: 4,
  },
  {
    id: 5,
    ...
    imageUrl: "/pizzas/example.png",
    description: "Kontrowersyjna, ale uwielbiana przez wielu.",
    rank: 5,
        ...
        <CarouselContent className="py-4 -ml-2 md:-ml-4">
          {topPizzasData.map((pizza, index) => (
            <CarouselItem
              ...
              className={cn(
                "pl-2 md:pl-4",
                "basis-[70%] sm:basis-[60%] md:basis-1/2 lg:basis-1/3",
                "py-4"
              )}
            >
              <div className="relative h-full">
                ...
                <Card
                  className={cn(
                    "overflow-hidden transition-all duration-300 ease-in-out h-full flex flex-col",
                ...
                >
                  <CardHeader className="p-0 relative aspect-video max-h-[160px] sm:max-h-[180px]">
                    <Image
                      src={pizza.imageUrl}
                      alt={pizza.name}
                      fill
